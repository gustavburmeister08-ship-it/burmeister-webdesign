...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:image", content: "https://burmeister-webdesign.de/images/gb-webdesign-arbeitsfoto.webp" },
    ],
    links: [
      {
        rel: "preconnect",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://burmeister-webdesign.de/images/gb-webdesign-arbeitsfoto.webp",
