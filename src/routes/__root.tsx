  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Es ist ein Fehler aufgetreten. Versuchen Sie es erneut oder gehen Sie zur Startseite.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Webdesigner in Leipzig für kleine Unternehmen. Websites ab 790 € – schnell umgesetzt, verständlich erklärt. Jetzt kostenloses Erstgespräch anfragen.",
      },
      { name: "author", content: "Gustav Burmeister" },
      { property: "og:site_name", content: "Gustav Burmeister Webdesign Leipzig" },
      { property: "og:title", content: "Gustav Burmeister Webdesign Leipzig" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          hasOfferCatalog: {
            ...
            itemListElement: [
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "Website-Erstellung", description: "Neue Websites für kleine Unternehmen in Leipzig." } },
              { "@type": "Offer", itemOffered: { "@type": "Service", name: "Website-Relaunch", description: "Modernisierung veralteter Websites." } },
